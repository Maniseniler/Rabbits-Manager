...
################################################################################
## Form generated from reading UI file 'mainViewRabbitTree.ui'
##
...
class Ui_Rabbits_Tree_View_Main(object):
    def setupUi(self, Rabbits_Tree_View_Main):
        if not Rabbits_Tree_View_Main.objectName():
            Rabbits_Tree_View_Main.setObjectName(u"Rabbits_Tree_View_Main")
        Rabbits_Tree_View_Main.resize(1031, 867)
        Rabbits_Tree_View_Main.setMinimumSize(QSize(1031, 867))
        Rabbits_Tree_View_Main.setMaximumSize(QSize(1031, 867))
        Rabbits_Tree_View_Main.setStyleSheet(u"")
        self.Background = QFrame(Rabbits_Tree_View_Main)
...
"font: 75 15pt \"Acme\";")
        ...
        self.Exit_Rabbits_Tree_View = QPushButton(self.Background)
        self.Exit_Rabbits_Tree_View.setObjectName(u"Exit_Rabbits_Tree_View")
        self.Exit_Rabbits_Tree_View.setEnabled(True)
        self.Exit_Rabbits_Tree_View.setGeometry(QRect(970, 30, 33, 33))
        self.Exit_Rabbits_Tree_View.setMinimumSize(QSize(33, 33))
        self.Exit_Rabbits_Tree_View.setMaximumSize(QSize(33, 33))
        font = QFont()
        font.setFamilies([u"Orbitron"])
        font.setPointSize(9)
        font.setBold(False)
        font.setItalic(False)
        self.Exit_Rabbits_Tree_View.setFont(font)
        self.Exit_Rabbits_Tree_View.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        self.Exit_Rabbits_Tree_View.setStyleSheet(u"QPushButton {\n"
"	border: none;\n"
"	background-color:rgba(0, 0, 0, 0);\n"
...
"}")
        self.Exit_Rabbits_Tree_View.setIconSize(QSize(20, 20))
        self.Exit_Rabbits_Tree_View.setCheckable(False)
        self.Exit_Rabbits_Tree_View.setAutoRepeat(False)
        self.Exit_Rabbits_Tree_View.setAutoExclusive(False)
        self.Exit_Rabbits_Tree_View.setAutoRepeatDelay(50)
        self.Exit_Rabbits_Tree_View.setAutoRepeatInterval(10)
...
"}")
        ...
        self.retranslateUi(Rabbits_Tree_View_Main)
        self.Exit_Rabbits_Tree_View.clicked.connect(Rabbits_Tree_View_Main.close)

        QMetaObject.connectSlotsByName(Rabbits_Tree_View_Main)
    # setupUi

    def retranslateUi(self, Rabbits_Tree_View_Main):
        Rabbits_Tree_View_Main.setWindowTitle(QCoreApplication.translate("Rabbits_Tree_View_Main", u"Dialog", None))
        self.Title.setText(QCoreApplication.translate("Rabbits_Tree_View_Main", u"Rabbits Tree Viewer Window", None))
        self.Exit_Rabbits_Tree_View.setText("")
#if QT_CONFIG(shortcut)
        self.Exit_Rabbits_Tree_View.setShortcut(QCoreApplication.translate("Rabbits_Tree_View_Main", u"Esc", None))
#endif // QT_CONFIG(shortcut)
        self.ScreenShot_Button.setText("")
#if QT_CONFIG(shortcut)
        self.ScreenShot_Button.setShortcut(QCoreApplication.translate("Rabbits_Tree_View_Main", u"Return", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
